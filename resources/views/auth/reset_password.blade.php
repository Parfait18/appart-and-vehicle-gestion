    ...
    <div class="container">
        <div class="screen">
            <div class="screen__content">
                ...
                <form method="POST" id="form-login" action="{{ route('change_password') }}" class="login" id="form-login">
                    @csrf
                    ...
                    <div class="login__field">
                        ...
                        <input type="password" id="password" name="password" class="login__input" placeholder="Nouveau Mot de passe" autocomplete="off">
                    </div>
                    <div class="login__field">
                        <i class="login__icon fas fa-lock"></i>
                        <input type="password" id="confirmation_password" name="confirmation_password" class="login__input" placeholder="Confirmation du mot de passe " autocomplete="off">
                        @error('password')
